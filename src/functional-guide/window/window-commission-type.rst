...
.. _functional-guide/window/window-commission-type:

===============
Commission Type
===============

Commission Type is used for define a custom commission

Help
====
Use it for define a custom commission calculation or search
